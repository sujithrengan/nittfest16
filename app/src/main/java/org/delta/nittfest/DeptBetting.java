 ...
 */
public class DeptBetting extends Activity {
    ...
    class AuthTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            myPd_ring  = new ProgressDialog (DeptBetting.this);
        ...
        protected void onPostExecute(String error) {
            ...
            switch (Utilities.status) {
                ...
                case 3:
                    Toast.makeText(DeptBetting.this, "Your account is not on the system. Please contact NITTFEST OC", Toast.LENGTH_SHORT).show();
